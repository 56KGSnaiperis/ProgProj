...
func _on_body_entered(body):
	if body.name == "Player":
		...
		# show player values
		$UI/Menu/MenuBackground/Container/TimeCompleted/Value.text = str(Global.final_time)
		$UI/Menu/MenuBackground/Container/Score/Value.text = str(Global.final_score)
		$UI/Menu/MenuBackground/Container/Ranking/Value.text = str(Global.final_rating)
